...
MEDIA_ROOT = BASE_DIR / 'media' # Um caminho onde os arquivos de midia seram salvos. 

STATIC_URL = 'static/' # É o endereço url inicial aonde estão os arquivos estáticos.
STATIC_ROOT = BASE_DIR / 'static' # Um caminho para onde os arquivos estáticos estão coletados
